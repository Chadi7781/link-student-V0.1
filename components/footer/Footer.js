...
function Footer() {
  return (
    ...
    <div class="flex flex-col items-center justify-center">
        <div>
                <h1 className='text-gray-800 dark:text-white hover:text-gray-500"'>Link Tunisia</h1>
        </div>
        ...
        <div class="flex items-center mt-6">
            <p class="text-base leading-4 text-gray-800 dark:text-gray-400">2021 <span class="font-semibold">Made by ChadiAcademy</span></p>
